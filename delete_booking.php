...
$query = "SELECT first_name, service_type FROM booking WHERE id = ?";
...
<head>
    ...
    <title>Delete Booking - Lifeline Care Center</title>
...
<body>
    <div class="delete-container">
        ...
        <div class="booking-info">
            <p><strong>Name:</strong> <?php echo htmlspecialchars($booking['first_name']); ?></p>
        ...
        <form method="POST" class="button-group">
            ...
            <a href="manageBooking.php" class="cancel-btn">Cancel</a>
        </form>
    </div>
</body>
</html>