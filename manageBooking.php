...
<body>
    <div class="side-menu">
        ...
        <ul>
            ...
            <li class="active"><i class="fa-solid fa-clipboard"></i>&nbsp; <span><a href="manageBooking.php">Bookings</a></span></li>
                            ...
                            if ($result) {
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td>
                                               <a href='delete_booking.php?id=" . urlencode($row['id']) . "' class='delete-btn'>Delete</a>
                                              </td>";
                                        echo "</tr>";
                                    }
                                } else {
